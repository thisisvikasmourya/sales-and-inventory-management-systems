...
class Login:
    ...
    # WIDGET FUNCTION
    def obj(self):
        self.loginframe=LabelFrame(self.loginw,bg="#4267b2",height=500,width=300)
    ...
    def reguser(self):
       ...
       # ADD
        ...
        self.register.place(x=35,y=440)
       # self.register.config(text="Back",command=self.revert)
        self.signin.config()
        self.signin.place(x=35, y=380)
        self.pa.config(show='')
        self.loginw.focus()
