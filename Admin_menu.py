...
class Admin:
    ...
    def admin_mainmenu(self,a,b):
         self.mainframe = LabelFrame(self.mainw, width=1200, height=140,bg="#4267b2")
         self.mainframe.place(x=100, y=100)
         mi = PhotoImage(file="images/accounts.png")
         mi = mi.subsample(a,b)
         self.accounts = Button(self.mainframe, text="Profiles",font="roboto 11 bold",bd=2, bg="#4267b2", image=mi, compound=TOP,command=self.buildusertable)
         self.accounts.image = mi
         self.accounts.place(x=655, y=27)
         mi = PhotoImage(file="images/Door_Out-512.png")
         mi = mi.subsample(a,b)
         self.logout = Button(self.mainframe, text="Quit",bd=2,font="roboto 11 bold",bg="#4267b2" ,image=mi, compound=TOP)
         self.logout.image = mi
         self.logout.place(x=1050, y=27)
         mi = PhotoImage(file="images/change1.png")
         mi = mi.subsample(a,b)
         self.changeuser = Button(self.mainframe, text="Sign out",bd=2,font="roboto 11 bold",bg="#4267b2", image=mi, compound=TOP)
         self.changeuser.image = mi
         self.changeuser.place(x=855, y=27)
         mi = PhotoImage(file="images/ADD.png")
         mi = mi.subsample(a,b)
         self.items = Button(self.mainframe, text="Items",bd=2, image=mi,font="roboto 11 bold",bg="#4267b2", compound=TOP,command=self.additems)
         self.items.image = mi
         self.items.place(x=47, y=27)
         mi = PhotoImage(file="images/inventory.png")
         mi = mi.subsample(a,b)
         self.stocks = Button(self.mainframe, text="Inventory",bd=2, image=mi,font="roboto 11 bold",bg="#4267b2", compound=TOP,command=self.buildprodtable)
         self.stocks.image = mi
         self.stocks.place(x=255, y=27)
         mi = PhotoImage(file="images/sales.png")
         mi=mi.subsample(a,b)
         self.sales = Button(self.mainframe, text="Sales",bd=2,font="roboto 11 bold",bg="#4267b2", image=mi, compound=TOP,command=self.buildsalestable)
         self.sales.image = mi
         self.sales.place(x=450, y=27)
         self.formframe = Frame(self.mainw, width=500, height=550, bg="#4267b2")
         ...
         self.itemframe = Frame(self.mainw, bg="#4267b2", width=600, height=300)
         self.itemframe.place(x=420, y=280, anchor=NW)
         self.itemframeinfo=self.itemframe.place_info()
         self.formframe1 = Frame(self.mainw, width=500, height=445, bg="#4267b2")
         self.formframe1.place(x=100,y=275)
         self.formframe1info = self.formframe1.place_info()
         self.searchframe = Frame(self.mainw, width=720, height=70, bg="#4267b2")
         self.searchframe.place(x=575, y=260)
         self.searchframeinfo = self.searchframe.place_info()
         self.searchbut = Button(self.searchframe, text="Search Description", font="roboto 14", bg="#4267b2", bd=5, command=self.searchprod)
         self.searchbut.place(x=0, y=20, height=40)
         self.searchvar=StringVar()
         self.searchentry = myentry(self.searchframe, textvariable=self.searchvar, font="roboto 14", width=25, bg="#4267b2")
         ...
         self.resetbut = Button(self.searchframe, text="Reset", font="roboto 14", bd=5, width=8, bg="#4267b2", command=self.resetprodtabel)
    ...
    def buildprodtable(self):
         ...
         for i in range(0,6):
             Label(self.formframe, text=l1[i], font="roboto 14 bold", bg="#4267b2").place(x=0, y=va)
             va += 60
         Entry(self.formframe, textvariable=self.itemeditv, font="roboto 14",bg="#4267b2", width=20).place(x=142, y=0, height=40)
         Entry(self.formframe, textvariable=self.itemeditdescv, font="roboto 14",bg="#4267b2", width=20).place(x=142, y=60, height=40)
         x=myentry(self.formframe, textvariable=self.itemeditcatv, font="roboto 14",bg="#4267b2", width=20)
         ...
         Entry(self.formframe, textvariable=self.itemeditpricev, font="roboto 14",bg="#4267b2", width=20).place(x=142, y=180, height=40)
         Entry(self.formframe, textvariable=self.itemeditstockv, font="roboto 14",bg="#4267b2", width=20).place(x=142, y=240, height=40)
         Entry(self.formframe, textvariable=self.addstock, font="roboto 14",bg="#4267b2", width=20).place(x=142, y=300, height=40)
         Button(self.formframe, text="Update", font="robot 11 bold",bg="#4267b2", bd=5, width=10, height=2,
         command=self.changeprodtable).place(x=105, y=361)
         Button(self.formframe, text="Remove", font="robot 11 bold",bg="#4267b2", bd=5, width=10, height=2,
    ...
    def additems(self):
        ...
        for i in range(0,len(l)):
            Label(self.itemframe,text=l[i],font="Roboto 14 bold",bg="#4267b2").grid(row=i,column=0,pady=15,sticky="w")
        Entry(self.itemframe, width=40, textvariable=self.newitemcode,font="roboto 11",bg="#4267b2").grid(row=0, column=1,pady=15,padx=10,ipady=3)
        Entry(self.itemframe,width=40,textvariable=self.newitem,font="roboto 11",bg="#4267b2").grid(row=1,column=1,pady=15,padx=10,ipady=3)
        Entry(self.itemframe,width=40,textvariable=self.newitemdesc,font="roboto 11",bg="#4267b2").grid(row=2,column=1,pady=15,padx=8,ipady=3)
        cat=myentry(self.itemframe,width=40,textvariable=self.newitemcat,font="roboto 11",bg="#4267b2")
        cat.grid(row=3,column=1,pady=15,padx=10,ipady=3)
        Entry(self.itemframe, width=40, textvariable=self.newitemprice,font="roboto 11",bg="#4267b2").grid(row=4, column=1, pady=15, padx=10,ipady=3)
        Entry(self.itemframe, width=40, textvariable=self.newitemstock,font="roboto 11",bg="#4267b2").grid(row=5, column=1, pady=15, padx=10,ipady=3)
        ...
        Button(self.itemframe,text="Add item",height=3,bd=6,command=self.insertitem,bg="#4267b2").grid(row=6,column=1,pady=10,padx=12,sticky="w",ipadx=10)
        Button(self.itemframe, text="Back", height=3,width=8, bd=6,command=self.buildprodtable,bg="#4267b2").grid(row=6, column=1,padx=16, pady=10,sticky="e",ipadx=10)
    ...
    def buildusertable(self):
         ...
         for i in range(0,3):
             Label(self.formframe1, text=l1[i], font="roboto 14 bold", bg="#4267b2").place(x=0, y=va)
             va += 70
         Entry(self.formframe1, textvariable=self.usernamedit, font="roboto 14", bg="#4267b2", width=25,state='readonly').place(x=162, y=105, height=40)
         Entry(self.formframe1, textvariable=self.passwordedit, font="roboto 14", bg="#4267b2", width=25).place(x=162, y=175, height=40)
         ...
         Button(self.formframe1, text="Create a User", font="robot 12 bold", bg="#4267b2", bd=5, width=12, height=2,
                command=self.adduser).place(x=0, y=10)
         Button(self.formframe1, text="Update", font="robot 12 bold", bg="#4267b2", bd=5, width=10, height=2,
                command=self.changeusertable).place(x=145, y=381)
         Button(self.formframe1, text="Remove", font="robot 12 bold", bg="#4267b2", bd=5, width=10, height=2,
